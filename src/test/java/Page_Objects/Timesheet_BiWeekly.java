...
public class Timesheet_BiWeekly {
	WebDriver driver;
	GenericLib lib;
	Properties  props;
	...
	public Timesheet_BiWeekly(WebDriver driver) throws IOException {
		this.driver=driver;
	...
	public void Clinical_BIWeeklyRegTimesheet(Map<String,String> hmap) throws InterruptedException, IOException, ParseException{
	...
	public void NonClinical_BiweeklyRegTimesheet(Map<String,String> hmap) throws InterruptedException, IOException, ParseException{
		driver.navigate().refresh();
		Thread.sleep(2000);
		FinanceTab.click();
		Thread.sleep(3000);
